...
let catString = string.slice(string.indexOf("c") + 1)
let eekString = catString.split("Eek!").join("")
let answer = eekString.split("").reverse().join("")
console.log("Secret message: ", answer)
let tomorrowTask = answer.split("v")
let tomorrowTaskAns = tomorrowTask.map(el => el[0]).slice(1)
console.log("Tomorrow's word of the day: ", tomorrowTaskAns)
